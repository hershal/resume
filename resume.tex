...
\begin{resume}
  ...
  \begin{adjustwidth}{1.5em}{0pt}
    As president, I designed competitions, developed lectures, and generally
    pushed the society to excel in its various endeavors. In addition, I made
    sure that everybody in the society is doing their part and resolved societal
    conflicts.
   \end{adjustwidth}
\end{resume}
\end{document}
